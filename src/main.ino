...
"<P>"
"<INPUT type=\"radio\" name=\"DST\" value=\"2\">Enable<BR>"
"<INPUT type=\"radio\" name=\"DST\" value=\"0\">Disable<BR>"
"</P>"
"Set UTC/GMT Offset<br>"
"<P>"
"<input type=\"text\" name=\"TZ\"> <INPUT type=\"submit\" value=\"Set\">"
"</P>"
"</FORM>"
"</body>"
"</html>";

const unsigned char asuka[] PROGMEM = {
...
const unsigned char miku[] PROGMEM = {
...
const unsigned char momiji[] PROGMEM = {
...
void handleRoot(){
  if (server.hasArg("TZ")) handleSubmit();
...
void handleSubmit(){
  ...
  if (!server.hasArg("TZ") || !server.hasArg("DST")) return returnFail("BAD ARGS");
  if (server.hasArg("TZ")){
...
void loop(){
  ...
  do {
    ...
    u8g2.drawXBMP(hPic, 0, 64, 64, momiji);
